...
public class Constants {
    ...
    public static double [] VALUES = null; // populated automatically
    public static double [][] CONSTRAINTS = null; // populated automatically
    public static double [] CAPACITIES = null; // populated automatically
    ...
    public static double OPTIMUM; // populated automatically
    public static boolean OPTIMUM_FOUND = false;
    public static int SHUFFLE_TOLERANCE = 5;
    ...
    public static int COUNT_TOLERANCE = 5;
